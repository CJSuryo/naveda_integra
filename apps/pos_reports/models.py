...
class DailySalesSnapshot(models.Model):
    ...
    qris_collected       = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    transfer_collected   = models.DecimalField(max_digits=15, decimal_places=2, default=0)
