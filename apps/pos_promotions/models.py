...
class Campaign(models.Model):
    ...
    applicable_products   = models.ManyToManyField('pos_catalog.POSProduct', blank=True)
    applicable_categories = models.ManyToManyField('pos_catalog.POSCategory', blank=True)
