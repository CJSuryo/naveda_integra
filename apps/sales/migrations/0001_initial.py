# Generated by Django 6.0.4 — squashed from old 0001+0002+0003 migrations.
# This file defines the schema that existed in production BEFORE the
# SalesEntitasBisnis refactor.  The new schema is reached by also applying
# 0002_sales_eb_groups.py.
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entitas_bisnis', models.ForeignKey(
                    ...
                    related_name='old_sales_headers',
                ...
                ('payment_account', models.ForeignKey(
                    ...
                    on_delete=django.db.models.deletion.PROTECT,
                    related_name='old_sales_payment_headers',
                    to='master_data.akun',
        ...
        migrations.AddIndex(
            model_name='salesheader',
            index=models.Index(fields=['entitas_bisnis', 'tanggal'], name='idx_nsh_eb_tanggal'),
        ),
        migrations.AddIndex(
            model_name='salesitem',
            index=models.Index(fields=['sales_header', 'item'], name='idx_nsi_header_item'),
        ),
        migrations.AddIndex(
            model_name='salesitem',
