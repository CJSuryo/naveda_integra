...
urlpatterns = [
    ...
    path('<int:pk>/set-akun-lancar/', views.piutang_set_akun_lancar, name='set_akun_lancar'),
    path('<int:pk>/reklasifikasi/<int:rkl_pk>/reverse/', views.piutang_reklasifikasi_reverse, name='reklasifikasi_reverse'),
    path('<int:pk>/reklasifikasi/<int:rkl_pk>/delete/', views.piutang_reklasifikasi_delete, name='reklasifikasi_delete'),
    ...
    path('<int:pk>/penyisihan/set-accounts/', views.piutang_penyisihan_set_accounts, name='penyisihan_set_accounts'),
    path('reports/penyisihan/', views.piutang_report_penyisihan, name='report_penyisihan'),
    path('reports/penyisihan/batch/<int:pk>/delete/', views.piutang_batch_penyisihan_delete, name='batch_penyisihan_delete'),
    ...
    path('<int:pk>/pv-accrual/', views.piutang_pv_accrual, name='pv_accrual'),
    path('<int:pk>/pv-accrual/reversal/', views.piutang_pv_accrual_reversal, name='pv_accrual_reversal'),
